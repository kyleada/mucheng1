...
public class SwipeViewPager extends RelativeLayout implements AutoInterface {
    ...
    public SwipeViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        onInitView();
    }

    private void onInitView() {
        View view = View.inflate(getContext(), R.layout.auto_viewpager_layout, this);
    ...
    private void addIndicatorImageViews(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i != 0) {
                lp.leftMargin = DensityUtil.dip2px(getContext(), 7);
            }
