...
package me.kkwang.commonlib.widget.wheel;
...
import me.kkwang.commonlib.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.wheel_divider_line));
		// 设置线宽
